...
export function ResumeDropdown() {
  return (
    <div className="absolute top-full left-0 w-full shadow-xl border-t border-border transform transition-all duration-300 bg-white dark:bg-neutral-900 backdrop-blur-md z-50">
      <div className="max-w-7xl mx-auto p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="rounded-lg p-6 bg-gray-50 dark:bg-gray-700">
          <h3 className="text-2xl font-bold mb-4">ATS-friendly resume builder</h3>
