...
import { Scissors, Maximize2, Layout, Type } from "lucide-react";
import Link from "next/link";

const OnePageResumePage: React.FC = () => {
  const [currentTip, setCurrentTip] = useState<number>(0);

  // Memoize the quickTips array so it remains stable across renders.
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-primary/10 to-background pb-16 pt-24">
        <div className="relative mx-auto max-w-[1200px] px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12">
            Learn expert techniques to condense your experience into a powerful
            single-page resume that hiring managers will love.
          </p>
        </div>
      </div>
        ...
        <Card className="relative overflow-hidden">
          ...
          <CardContent className="relative p-12 text-center text-primary-foreground">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              Use our AI-powered Resume Analyzer to ensure your condensed resume
              maintains maximum impact.
            </p>
